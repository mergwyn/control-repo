...
mod 'puppetlabs/apache', :git => 'https://github.com/puppetlabs/puppetlabs-apache', :tag => 'v13.1.0'
...
mod 'puppetlabs/mysql', :git => 'https://github.com/puppetlabs/puppetlabs-mysql', :tag => 'v16.3.0'
...
mod 'puppet/systemd', :git => 'https://github.com/camptocamp/puppet-systemd', :tag => 'v9.4.0'
...
# https://github.com/mergwyn/puppet-homebrew', :branch => 'master'
