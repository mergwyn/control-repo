...
#mod 'mergwyn/managedmac', :git => 'https://github.com/mergwyn/mergwyn-managedmac', :ref => '0.8.2'
...
#mod 'puppet/homebrew', :git => 'https://github.com/TheKevJames/puppet-homebrew', :branch => 'master'
mod 'puppet/homebrew', :git => 'https://github.com/sebastianrakel/puppet-homebrew', :branch => 'update'
