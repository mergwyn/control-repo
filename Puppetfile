...
#mod 'herculesteam-augeasproviders_shellvar', :git => 'https://github.com/mergwyn/augeasproviders_shellvar'
...
mod 'thekevjames-homebrew', :git => 'https://github.com/frozenfoxx/puppet-homebrew', :branch => 'patch-1'
