...
#  end
  MockFunction.new('puppetdb_query') { |f|
    f.stubs(:call).with([['from', 'resources', ['and', ['=', 'type', 'Zabbix_template_host'], ['=', ['parameter', 'ensure'], 'present'], ['~', 'title', '.*@unittest.theclarkhome.com']]]]).returns([{ 'title' => 'fqdn', 'value' => 'certname.example.com' }])
  }
end
